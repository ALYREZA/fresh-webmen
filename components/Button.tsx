...
export function Button(props: JSX.HTMLAttributes<HTMLButtonElement>) {
  ...
  const defaultClasses = "px-2 py-1 border-border-button-secondary border-2 rounded bg-button-secondary-bg text-button-secondary-text hover:bg-button-secondary-hover-bg transition-colors";
